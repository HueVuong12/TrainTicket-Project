...
//		header.setBounds(0, 5, 1295, 177);
//		contentPane.add(header);
//		header.setLayout(null);
//		
//		title = new JPanel();
//		title.setBounds(0, 0, 1029, 177);
...
//		//Menu Chính
//		jp_menu = new JPanel();
//		jp_menu.setBackground(SystemColor.controlHighlight);
//		jp_menu.setBounds(0, 124, 1029, 53);
//		title.add(jp_menu);
//		jp_menu.setLayout(null);
//		
//		menuBar = new JMenuBar();
//		menuBar.setBackground(SystemColor.controlHighlight);
//		menuBar.setBounds(0, 0, 1029, 53);
//		menuBar.setBorder(new MatteBorder(0, 0, 0, 0, Color.WHITE));
//		jp_menu.add(menuBar);
//		
//		khachHang = new JMenu("Khách hàng");
//		khachHang.setBackground(SystemColor.controlHighlight);
//		khachHang.setFont(new Font("Segoe UI", Font.BOLD, 20));
//		khachHang.setPreferredSize(new Dimension(150, 30));
//		menuBar.add(khachHang);
//		
//		ve = new JMenu("Vé tàu");
//		ve.setBackground(SystemColor.controlHighlight);
...
//		hoaDon.setBackground(SystemColor.controlHighlight);
...
//		traCuuKH.setBackground(SystemColor.controlHighlight);
...
//		
//		traCuuNV = new JMenuItem("Tra cứu tài khoản ");
//		traCuuKH.add(traCuuNV);
//		
//		thongKe = new JMenu("Thống kê");
//		thongKe.setBackground(SystemColor.controlHighlight);
...
//		
//		nhanVien = new JMenu("tài khoản");
//		nhanVien.setBackground(SystemColor.controlHighlight);
...
//		taiKhoan.setBackground(SystemColor.controlHighlight);
...
//		jp_nhanVien.setBackground(SystemColor.controlHighlight);
//		jp_nhanVien.setBounds(1028, 0, 267, 177);
...
//	  				);
		...
		jp_timKiem.setBounds(300, 38, 1160, 76);
		add(jp_timKiem);
		...
		jp_content.setBounds(0, 32, 1160, 44);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (row != -1) {
			TaiKhoan tk = dstk.getTaiKhoanByMa(table_TK.getModel().getValueAt(row, 0).toString());
			textField_MaNV.setText(tk.getNhanVien().getMaNV());
			textField_MaDN.setText(tk.getMaDangNhap());
		...
		if(o.equals(btnThem)) {
			if (validData()) {
				...
				if (tk != null) {
					...
					TaiKhoan existingTK = dstk.getTaiKhoanByMa(tk.getMaDangNhap());
					if (existingTK != null) {
	...
	//Hàm tìm kiếm tài khoản
		public void search() {
			if (validData()) {
				...
				TaiKhoan tk = dstk.getTaiKhoanByMa(maDN);
				if (tk != null) { // Kiểm tra xem đối tượng SanPham có null không trước khi thêm vào bảng
					model.setRowCount(0);
					model.addRow(new Object[] {tk.getMaDangNhap(),tk.getMatKhau(),tk.getPhanQuyen(),tk.getNhanVien().getMaNV() 
					});
				}
			}else {
